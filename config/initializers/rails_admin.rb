# RailsAdmin config file. Generated on January 27, 2014 19:32
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Releaf', 'Admin']
  ...
  # config.excluded_models = ['Admin', 'Event', 'Library', 'Message', 'Resource', 'User', 'UserEvent']

  # Include specific models (exclude the others):
  # config.included_models = ['Admin', 'Event', 'Library', 'Message', 'Resource', 'User', 'UserEvent']
  ...
  #     configure :user_events, :has_many_association 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your user_event.rb model definition
